...
def from_char(data: Union[ct.c_char, ct.Array], n_str: int) -> Iterator[str]:
    """
...
def from_char_array(data: Union[ct.c_char, ct.Array], str_size: int) -> Iterator[str]:
    """
...
def from_n_char_array(data: Union[ct.c_char, ct.Array], str_size: int, n_str: int) -> Iterator[str]:
    """
    Split a buffer of fixed size string.
